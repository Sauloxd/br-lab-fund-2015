...
LOOPRD	SC READ1		;PULAR LINHA
		SC READ1		;ler próxima instrução
...
PROCD  	$ /0001
		SC READ1 ;DESCARTA, é pular linha (descarta eol)
		SC READ1	;lê argumento do Dumper 1-Tamanho bloco
		;SC VRFARG
		MM DUMP_BL
		SC READ1 ;RETIRA CARACTERES BRANCOS
		SC READ1 ;lê argumento do Dumper 2-End. Inicial
		;SC VRFARG
		MM DUMP_INI
		SC READ1 ;RETIRA CARACTERES BRANCOS
		SC READ1	;lê argumento do Dumper 3-Tamanho
		;SC VRFARG
		MM DUMP_TAM
		SC READ1 ;RETIRA CARACTERES BRANCOS
		SC READ1 ;lê argumento do Dumper 4-Endereço Início Execução
		;SC VRFARG
		MM DUMP_EXE
		SC READ1 ;RETIRA CARACTERES BRANCOS
		SC READ1 ;PULA LINHA		
...
PROCL  	$ /0001
		SC READ1 ;DESCARTA, é pular linha
		SC READ1	;lê argumento do Loader
		;SC VRFARG
		MM LOADER_UL
		SC LOADER
		RS PROCL
